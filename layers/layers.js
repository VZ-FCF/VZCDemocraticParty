...
//ol.proj.get("EPSG:3857").setExtent([-10738940.725238, 3788628.131993, -10567553.040089, 3894182.946185]);
var wms_layers = [];
...
var format_VZC_Pct3_3 = new ol.format.GeoJSON();
var features_VZC_Pct3_3 = format_VZC_Pct3_3.readFeatures(json_VZC_Pct3_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_VZC_Pct3_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_VZC_Pct3_3.addFeatures(features_VZC_Pct3_3);
var lyr_VZC_Pct3_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_VZC_Pct3_3, 
                style: style_VZC_Pct3_3,
                popuplayertitle: 'VZC_Pct3',
                interactive: false,
                title: '<img src="styles/legend/VZC_Pct3_3.png" /> VZC_Pct3'
            });
var format_VZC_Pct4_4 = new ol.format.GeoJSON();
var features_VZC_Pct4_4 = format_VZC_Pct4_4.readFeatures(json_VZC_Pct4_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_VZC_Pct4_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_VZC_Pct4_4.addFeatures(features_VZC_Pct4_4);
var lyr_VZC_Pct4_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_VZC_Pct4_4, 
                style: style_VZC_Pct4_4,
                popuplayertitle: 'VZC_Pct4',
                interactive: false,
                title: '<img src="styles/legend/VZC_Pct4_4.png" /> VZC_Pct4'
            });
var format_VZC_Pct1_5 = new ol.format.GeoJSON();
var features_VZC_Pct1_5 = format_VZC_Pct1_5.readFeatures(json_VZC_Pct1_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_VZC_Pct1_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_VZC_Pct1_5.addFeatures(features_VZC_Pct1_5);
var lyr_VZC_Pct1_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_VZC_Pct1_5, 
                style: style_VZC_Pct1_5,
                popuplayertitle: 'VZC_Pct1',
                interactive: false,
                title: '<img src="styles/legend/VZC_Pct1_5.png" /> VZC_Pct1'
            });
var format_VZC_Pct2_6 = new ol.format.GeoJSON();
var features_VZC_Pct2_6 = format_VZC_Pct2_6.readFeatures(json_VZC_Pct2_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_VZC_Pct2_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_VZC_Pct2_6.addFeatures(features_VZC_Pct2_6);
var lyr_VZC_Pct2_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_VZC_Pct2_6, 
                style: style_VZC_Pct2_6,
                popuplayertitle: 'VZC_Pct2',
                interactive: false,
                title: '<img src="styles/legend/VZC_Pct2_6.png" /> VZC_Pct2'
            });
...
var format_VZC_ESD4_WP_VFD_8 = new ol.format.GeoJSON();
var features_VZC_ESD4_WP_VFD_8 = format_VZC_ESD4_WP_VFD_8.readFeatures(json_VZC_ESD4_WP_VFD_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_VZC_ESD4_WP_VFD_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_VZC_ESD4_WP_VFD_8.addFeatures(features_VZC_ESD4_WP_VFD_8);
var lyr_VZC_ESD4_WP_VFD_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_VZC_ESD4_WP_VFD_8, 
                style: style_VZC_ESD4_WP_VFD_8,
                popuplayertitle: 'VZC_ESD4_WP_VFD',
                interactive: false,
                title: '<img src="styles/legend/VZC_ESD4_WP_VFD_8.png" /> VZC_ESD4_WP_VFD'
            });
var format_VZC_ESD3_S_VZ_VFD_9 = new ol.format.GeoJSON();
var features_VZC_ESD3_S_VZ_VFD_9 = format_VZC_ESD3_S_VZ_VFD_9.readFeatures(json_VZC_ESD3_S_VZ_VFD_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_VZC_ESD3_S_VZ_VFD_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_VZC_ESD3_S_VZ_VFD_9.addFeatures(features_VZC_ESD3_S_VZ_VFD_9);
var lyr_VZC_ESD3_S_VZ_VFD_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_VZC_ESD3_S_VZ_VFD_9, 
                style: style_VZC_ESD3_S_VZ_VFD_9,
                popuplayertitle: 'VZC_ESD3_S_VZ_VFD',
                interactive: false,
                title: '<img src="styles/legend/VZC_ESD3_S_VZ_VFD_9.png" /> VZC_ESD3_S_VZ_VFD'
            });
var format_VZC_ESD1_Mabank_VFD_10 = new ol.format.GeoJSON();
var features_VZC_ESD1_Mabank_VFD_10 = format_VZC_ESD1_Mabank_VFD_10.readFeatures(json_VZC_ESD1_Mabank_VFD_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_VZC_ESD1_Mabank_VFD_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_VZC_ESD1_Mabank_VFD_10.addFeatures(features_VZC_ESD1_Mabank_VFD_10);
var lyr_VZC_ESD1_Mabank_VFD_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_VZC_ESD1_Mabank_VFD_10, 
                style: style_VZC_ESD1_Mabank_VFD_10,
                popuplayertitle: 'VZC_ESD1_Mabank_VFD',
                interactive: false,
                title: '<img src="styles/legend/VZC_ESD1_Mabank_VFD_10.png" /> VZC_ESD1_Mabank_VFD'
            });
var format_VZC_ESD2_GS_VFD_11 = new ol.format.GeoJSON();
var features_VZC_ESD2_GS_VFD_11 = format_VZC_ESD2_GS_VFD_11.readFeatures(json_VZC_ESD2_GS_VFD_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_VZC_ESD2_GS_VFD_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_VZC_ESD2_GS_VFD_11.addFeatures(features_VZC_ESD2_GS_VFD_11);
var lyr_VZC_ESD2_GS_VFD_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_VZC_ESD2_GS_VFD_11, 
                style: style_VZC_ESD2_GS_VFD_11,
                popuplayertitle: 'VZC_ESD2_GS_VFD',
                interactive: false,
                title: '<img src="styles/legend/VZC_ESD2_GS_VFD_11.png" /> VZC_ESD2_GS_VFD'
            });

lyr_GoogleMaps_0.setVisible(true);lyr_VanZandtCounty_1.setVisible(true);lyr_VZC_ISD_2.setVisible(false);lyr_VZC_Pct3_3.setVisible(false);lyr_VZC_Pct4_4.setVisible(false);lyr_VZC_Pct1_5.setVisible(false);lyr_VZC_Pct2_6.setVisible(false);lyr_VZC_Precincts_7.setVisible(true);lyr_VZC_ESD4_WP_VFD_8.setVisible(false);lyr_VZC_ESD3_S_VZ_VFD_9.setVisible(false);lyr_VZC_ESD1_Mabank_VFD_10.setVisible(false);lyr_VZC_ESD2_GS_VFD_11.setVisible(false);
var layersList = [lyr_GoogleMaps_0,lyr_VanZandtCounty_1,lyr_VZC_ISD_2,lyr_VZC_Pct3_3,lyr_VZC_Pct4_4,lyr_VZC_Pct1_5,lyr_VZC_Pct2_6,lyr_VZC_Precincts_7,lyr_VZC_ESD4_WP_VFD_8,lyr_VZC_ESD3_S_VZ_VFD_9,lyr_VZC_ESD1_Mabank_VFD_10,lyr_VZC_ESD2_GS_VFD_11];
...
lyr_VZC_Pct3_3.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'CNTY': 'CNTY', 'COLOR': 'COLOR', 'PREC': 'PREC', 'PCTKEY': 'PCTKEY', 'cntykey': 'cntykey', 'Shape_area': 'Shape_area', 'Shape_len': 'Shape_len', 'LOC': 'LOC', 'LINK': 'LINK', });
lyr_VZC_Pct4_4.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'CNTY': 'CNTY', 'COLOR': 'COLOR', 'PREC': 'PREC', 'PCTKEY': 'PCTKEY', 'cntykey': 'cntykey', 'Shape_area': 'Shape_area', 'Shape_len': 'Shape_len', 'LOC': 'LOC', 'LINK': 'LINK', });
lyr_VZC_Pct1_5.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'CNTY': 'CNTY', 'COLOR': 'COLOR', 'PREC': 'PREC', 'PCTKEY': 'PCTKEY', 'cntykey': 'cntykey', 'Shape_area': 'Shape_area', 'Shape_len': 'Shape_len', 'LOC': 'LOC', 'LINK': 'LINK', });
lyr_VZC_Pct2_6.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'CNTY': 'CNTY', 'COLOR': 'COLOR', 'PREC': 'PREC', 'PCTKEY': 'PCTKEY', 'cntykey': 'cntykey', 'Shape_area': 'Shape_area', 'Shape_len': 'Shape_len', 'LOC': 'LOC', 'LINK': 'LINK', });
...
lyr_VZC_Pct3_3.set('fieldImages', {'OBJECTID': '', 'CNTY': '', 'COLOR': '', 'PREC': '', 'PCTKEY': '', 'cntykey': '', 'Shape_area': '', 'Shape_len': '', 'LOC': '', 'LINK': '', });
lyr_VZC_Pct4_4.set('fieldImages', {'OBJECTID': '', 'CNTY': '', 'COLOR': '', 'PREC': '', 'PCTKEY': '', 'cntykey': '', 'Shape_area': '', 'Shape_len': '', 'LOC': '', 'LINK': '', });
lyr_VZC_Pct1_5.set('fieldImages', {'OBJECTID': '', 'CNTY': '', 'COLOR': '', 'PREC': '', 'PCTKEY': '', 'cntykey': '', 'Shape_area': '', 'Shape_len': '', 'LOC': '', 'LINK': '', });
lyr_VZC_Pct2_6.set('fieldImages', {'OBJECTID': '', 'CNTY': '', 'COLOR': '', 'PREC': '', 'PCTKEY': '', 'cntykey': '', 'Shape_area': '', 'Shape_len': '', 'LOC': '', 'LINK': '', });
...
lyr_VZC_ESD3_S_VZ_VFD_9.set('fieldImages', {'COUNTY_SUB': '', 'SOURCE': '', 'USER_ID': '', 'ESN_NUM': '', 'ESN_CITY': '', 'ESN_COUNTY': '', 'ESN_STATE': '', 'ESN_LAW': '', 'ESN_FIRE': '', 'ESN_EMS': '', 'CREATION_U': '', 'MODIFY_USE': '', 'created_us': '', 'created_da': '', 'last_edite': '', 'C1_Excepti': '', 'TEST': '', 'DiscrpAgID': '', 'DateUpdate': '', 'Effective': '', 'Expire': '', 'ES_NGUID': '', 'State': '', 'Fire_Agenc': '', 'Law_Agency': '', 'EMS_Agency': '', 'Fire_Servi': '', 'Law_Servic': '', 'EMS_Servic': '', 'Fire_Ser_1': '', 'Law_Serv_1': '', 'EMS_Serv_1': '', 'Fire_AVcar': '', 'Law_AVcard': '', 'EMS_AVcard': '', 'GC_Excepti': '', 'Fire_Ser_2': '', 'Law_Serv_2': '', 'EMS_Serv_2': '', 'GlobalID': '', 'last_edi_1': '', 'PSAP_Servi': '', });
lyr_VZC_ESD1_Mabank_VFD_10.set('fieldImages', {'COUNTY_SUB': '', 'SOURCE': '', 'USER_ID': '', 'ESN_NUM': '', 'ESN_CITY': '', 'ESN_COUNTY': '', 'ESN_STATE': '', 'ESN_LAW': '', 'ESN_FIRE': '', 'ESN_EMS': '', 'CREATION_U': '', 'MODIFY_USE': '', 'created_us': '', 'created_da': '', 'last_edite': '', 'C1_Excepti': '', 'TEST': '', 'DiscrpAgID': '', 'DateUpdate': '', 'Effective': '', 'Expire': '', 'ES_NGUID': '', 'State': '', 'Fire_Agenc': '', 'Law_Agency': '', 'EMS_Agency': '', 'Fire_Servi': '', 'Law_Servic': '', 'EMS_Servic': '', 'Fire_Ser_1': '', 'Law_Serv_1': '', 'EMS_Serv_1': '', 'Fire_AVcar': '', 'Law_AVcard': '', 'EMS_AVcard': '', 'GC_Excepti': '', 'Fire_Ser_2': '', 'Law_Serv_2': '', 'EMS_Serv_2': '', 'GlobalID': '', 'last_edi_1': '', 'PSAP_Servi': '', });
lyr_VZC_ESD2_GS_VFD_11.set('fieldImages', {'COUNTY_SUB': '', 'SOURCE': '', 'USER_ID': '', 'ESN_NUM': '', 'ESN_CITY': '', 'ESN_COUNTY': '', 'ESN_STATE': '', 'ESN_LAW': '', 'ESN_FIRE': '', 'ESN_EMS': '', 'CREATION_U': '', 'MODIFY_USE': '', 'created_us': '', 'created_da': '', 'last_edite': '', 'C1_Excepti': '', 'TEST': '', 'DiscrpAgID': '', 'DateUpdate': '', 'Effective': '', 'Expire': '', 'ES_NGUID': '', 'State': '', 'Fire_Agenc': '', 'Law_Agency': '', 'EMS_Agency': '', 'Fire_Servi': '', 'Law_Servic': '', 'EMS_Servic': '', 'Fire_Ser_1': '', 'Law_Serv_1': '', 'EMS_Serv_1': '', 'Fire_AVcar': '', 'Law_AVcard': '', 'EMS_AVcard': '', 'GC_Excepti': '', 'Fire_Ser_2': '', 'Law_Serv_2': '', 'EMS_Serv_2': '', 'GlobalID': '', 'last_edi_1': '', 'PSAP_Servi': '', });
...
lyr_VZC_Pct3_3.set('fieldLabels', {'OBJECTID': 'no label', 'CNTY': 'no label', 'COLOR': 'no label', 'PREC': 'no label', 'PCTKEY': 'no label', 'cntykey': 'no label', 'Shape_area': 'no label', 'Shape_len': 'no label', 'LOC': 'no label', 'LINK': 'no label', });
lyr_VZC_Pct4_4.set('fieldLabels', {'OBJECTID': 'no label', 'CNTY': 'no label', 'COLOR': 'no label', 'PREC': 'no label', 'PCTKEY': 'no label', 'cntykey': 'no label', 'Shape_area': 'no label', 'Shape_len': 'no label', 'LOC': 'no label', 'LINK': 'no label', });
lyr_VZC_Pct1_5.set('fieldLabels', {'OBJECTID': 'no label', 'CNTY': 'no label', 'COLOR': 'no label', 'PREC': 'no label', 'PCTKEY': 'no label', 'cntykey': 'no label', 'Shape_area': 'no label', 'Shape_len': 'no label', 'LOC': 'no label', 'LINK': 'no label', });
lyr_VZC_Pct2_6.set('fieldLabels', {'OBJECTID': 'hidden field', 'CNTY': 'inline label - always visible', 'COLOR': 'inline label - always visible', 'PREC': 'no label', 'PCTKEY': 'no label', 'cntykey': 'no label', 'Shape_area': 'no label', 'Shape_len': 'no label', 'LOC': 'no label', 'LINK': 'no label', });
...
lyr_VZC_ESD3_S_VZ_VFD_9.set('fieldLabels', {'COUNTY_SUB': 'no label', 'SOURCE': 'no label', 'USER_ID': 'no label', 'ESN_NUM': 'no label', 'ESN_CITY': 'no label', 'ESN_COUNTY': 'no label', 'ESN_STATE': 'no label', 'ESN_LAW': 'no label', 'ESN_FIRE': 'no label', 'ESN_EMS': 'no label', 'CREATION_U': 'no label', 'MODIFY_USE': 'no label', 'created_us': 'no label', 'created_da': 'no label', 'last_edite': 'no label', 'C1_Excepti': 'no label', 'TEST': 'no label', 'DiscrpAgID': 'no label', 'DateUpdate': 'no label', 'Effective': 'no label', 'Expire': 'no label', 'ES_NGUID': 'no label', 'State': 'no label', 'Fire_Agenc': 'no label', 'Law_Agency': 'no label', 'EMS_Agency': 'no label', 'Fire_Servi': 'no label', 'Law_Servic': 'no label', 'EMS_Servic': 'no label', 'Fire_Ser_1': 'no label', 'Law_Serv_1': 'no label', 'EMS_Serv_1': 'no label', 'Fire_AVcar': 'no label', 'Law_AVcard': 'no label', 'EMS_AVcard': 'no label', 'GC_Excepti': 'no label', 'Fire_Ser_2': 'no label', 'Law_Serv_2': 'no label', 'EMS_Serv_2': 'no label', 'GlobalID': 'no label', 'last_edi_1': 'no label', 'PSAP_Servi': 'no label', });
lyr_VZC_ESD1_Mabank_VFD_10.set('fieldLabels', {'COUNTY_SUB': 'no label', 'SOURCE': 'no label', 'USER_ID': 'no label', 'ESN_NUM': 'no label', 'ESN_CITY': 'no label', 'ESN_COUNTY': 'no label', 'ESN_STATE': 'no label', 'ESN_LAW': 'no label', 'ESN_FIRE': 'no label', 'ESN_EMS': 'no label', 'CREATION_U': 'no label', 'MODIFY_USE': 'no label', 'created_us': 'no label', 'created_da': 'no label', 'last_edite': 'no label', 'C1_Excepti': 'no label', 'TEST': 'no label', 'DiscrpAgID': 'no label', 'DateUpdate': 'no label', 'Effective': 'no label', 'Expire': 'no label', 'ES_NGUID': 'no label', 'State': 'no label', 'Fire_Agenc': 'no label', 'Law_Agency': 'no label', 'EMS_Agency': 'no label', 'Fire_Servi': 'no label', 'Law_Servic': 'no label', 'EMS_Servic': 'no label', 'Fire_Ser_1': 'no label', 'Law_Serv_1': 'no label', 'EMS_Serv_1': 'no label', 'Fire_AVcar': 'no label', 'Law_AVcard': 'no label', 'EMS_AVcard': 'no label', 'GC_Excepti': 'no label', 'Fire_Ser_2': 'no label', 'Law_Serv_2': 'no label', 'EMS_Serv_2': 'no label', 'GlobalID': 'no label', 'last_edi_1': 'no label', 'PSAP_Servi': 'no label', });
lyr_VZC_ESD2_GS_VFD_11.set('fieldLabels', {'COUNTY_SUB': 'inline label - visible with data', 'SOURCE': 'no label', 'USER_ID': 'no label', 'ESN_NUM': 'no label', 'ESN_CITY': 'no label', 'ESN_COUNTY': 'no label', 'ESN_STATE': 'no label', 'ESN_LAW': 'no label', 'ESN_FIRE': 'no label', 'ESN_EMS': 'no label', 'CREATION_U': 'no label', 'MODIFY_USE': 'no label', 'created_us': 'no label', 'created_da': 'no label', 'last_edite': 'no label', 'C1_Excepti': 'no label', 'TEST': 'no label', 'DiscrpAgID': 'no label', 'DateUpdate': 'no label', 'Effective': 'no label', 'Expire': 'no label', 'ES_NGUID': 'no label', 'State': 'no label', 'Fire_Agenc': 'no label', 'Law_Agency': 'no label', 'EMS_Agency': 'no label', 'Fire_Servi': 'no label', 'Law_Servic': 'no label', 'EMS_Servic': 'no label', 'Fire_Ser_1': 'no label', 'Law_Serv_1': 'no label', 'EMS_Serv_1': 'no label', 'Fire_AVcar': 'no label', 'Law_AVcard': 'no label', 'EMS_AVcard': 'no label', 'GC_Excepti': 'no label', 'Fire_Ser_2': 'no label', 'Law_Serv_2': 'no label', 'EMS_Serv_2': 'no label', 'GlobalID': 'no label', 'last_edi_1': 'no label', 'PSAP_Servi': 'no label', });
lyr_VZC_ESD2_GS_VFD_11.on('precompose', function(evt) {
